...
function confirmar_cadastro_html(codigo){
    return `<!DOCTYPE html>
<html lang="pt-BR">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Confirme sua conta - Bryandex Developer</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="email-container">
        ...
        <div class="content">
            <h1 class="welcome-title">Confirme sua conta</h1>
            <p class="welcome-text">
                Olá! Estamos quase terminando o processo de criação da sua conta na Bryandex Developer. 
                Para garantir a segurança, precisamos confirmar seu email.
            </p>
            ...
            <div class="instructions">
                ...
                <p>1. Volte para a tela de cadastro na Bryandex Developer<br>
                2. Digite o código de 6 dígitos no campo indicado<br>
                3. Clique em "Confirmar" para ativar sua conta</p>
            </div>
            ...
            <div class="security-note">
                ...
                <p>Nunca compartilhe este código com outras pessoas. Nossa equipe jamais solicitará seu código por telefone, email ou mensagem. Se você não solicitou este cadastro, ignore este email.</p>
            </div>
        </div>
        
        <div class="footer">
            <p>Este email foi enviado para você porque alguém tentou criar uma conta com este endereço.</p>
...
module.exports = {confirmar_cadastro_html}